...
========================================*/
  ...
  $(document).ready(function () {
    ...
    jQuery('.backtotop-wrap').on('click', function (event) {
      ...
      ); /* Fixing parseInt call with radix parameter */
      return false;
    });
    ...
    function makeTimer(endTime, countdownElementId) {
      ...
      if (timeLeft <= 0) {
        ...
        $('#' + countdownElementId + " [data-unit='days']").html(
          '00<span>Days</span>'
        );
        $('#' + countdownElementId + " [data-unit='hours']").html(
          '00<span>Hours</span>'
        );
        $('#' + countdownElementId + " [data-unit='minutes']").html(
          '00<span>Minutes</span>'
        );
        $('#' + countdownElementId + " [data-unit='seconds']").html(
      ...
      $('.rs-text-circle').each(function () {
        ...
        $(this)
          ...
          .each(function (index) {
            $(this).css(
              'transform',
              'rotate(' + (index + 1) * rotateDegree + 'deg)'
            );
          });
      });
    }
